...
for (let i = 0; i < Btnslider.length; i++) {
    Btnslider[i].addEventListener("click", function () {
        ...
        if(i === 0){
            Div.style.backgroundImage = 'url("Imagens/Banner\ do\ C.png")'
            tc.textContent = "Tópicos de C e C++"
        } else if(i === 1){
            Div.style.backgroundImage = 'url("Imagens/Banner\ do\ Java.png")'
            tc.textContent = "Liguagem Java"
        } else if(i === 2){
            Div.style.backgroundImage = 'url("Imagens/Banner\ do\ SQL.png")'
